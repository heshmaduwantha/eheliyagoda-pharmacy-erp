...
export function CartLine({ line, onQuantityChange, onSelectUnit, onRemove, onChangeBatch }: Props) {
  return (
    <article className="rounded-xl border border-neutral-border bg-neutral-surface p-3 shadow-sm">
      <div className="flex gap-3">
        <div className="min-w-0 flex-1">
          <div className="flex items-start justify-between gap-2">
            <div>
              <h3 className="font-bold text-sm text-neutral-text line-clamp-1">{line.productName}</h3>
              <p className="mt-0.5 text-[10px] text-neutral-muted truncate">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-between gap-2">
            <div className="flex items-center gap-2">
              <div className="flex h-8 items-center rounded-lg border border-neutral-border">
                <button
                  aria-label="Decrease quantity"
                  className="grid size-8 place-items-center text-neutral-muted hover:bg-neutral-bg"
              ...
              <button
                className="flex h-8 items-center justify-between gap-1.5 rounded-lg border border-neutral-border px-2 text-left text-xs font-semibold text-neutral-text hover:border-brand-default/20"
